...
<body>
	...
	<form action="supplier" method="post">
		...
		SupplierId: <input type="text" name="supplierId" required><br>
		<br> SupplierName <input type="text" name="supplierName" required><br>
		<br> Place <input type="text" name="place" required><br>
